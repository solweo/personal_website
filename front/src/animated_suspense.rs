...
//                 // move || match show.get() {
//                 //     true => view! { <div class=move || cls.get()>{children_rendered}</div> },
//                 //     false => view! { <div class=move || fb_cls.get()>{fallback()}</div> },
//                 // }

//                 // if show.get() {
//                 //     // children_rendered
//                 //     view! { <div class=move || cls.get()>{children_rendered}</div> }
//                 // } else {
//                 //     // fallback.get_untracked()
//                 //     view! { <div class=move || fb_cls.get()>{fallback.get_untracked()}</div> }
//                 // }

//                 match show.get() {
//                     true => view! { <div class=move || cls.get()>{children_rendered}</div> },
//                     false => view! { <div class=move || fb_cls.get()>{fallback.get_untracked()}</div> },
//                 }

//                 // use crate::animated_show_switch::AnimatedShowSwitch;
...
//                 //         fallback = move || view!{<div>{&children_rendered}</div>}
//                 //     >
//                 //         <div>{fallback.get_untracked()}</div>
//                 //     </AnimatedShowSwitch>
//                 // }

//                 // use leptos::html::div.ch
...
//                 let show = create_rw_signal(ready.get());
//                 let handle: StoredValue<Option<TimeoutHandle>> = store_value(None);
//                 let (cls, fb_cls) = match ready.get() {
//                     true => (create_rw_signal(intro), create_rw_signal(fallback_outro)),
//                     false => (create_rw_signal(outro), create_rw_signal(fallback_intro)),
//                 };
...
// /// Leptos' `<AnimatedShow>` based component 
// #[cfg_attr(
//     any(debug_assertions, feature = "ssr"),
//     tracing::instrument(level = "trace", skip_all)
// )]
